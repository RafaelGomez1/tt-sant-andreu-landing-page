...
const es: Translation = {
  ...
  contact: {
    ...
    info: {
      ...
      emailLabel: 'Email',
      email: 'santandreutennistaula@gmail.com',
      addressLabel: 'Dirección',
      address: 'Carrer Coroleu, 15 2n 08030 Barcelona',
    },
        ...
        plans: [
          {
            ...
            features: [
              'Per a jugadors amb experiència',
              'Grups reduïts amb entrenador',
